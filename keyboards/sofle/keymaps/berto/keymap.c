 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            |      | LAlt | LCTR |CMD   | /SHIFT  /       \MO(2) \  |SPACE |MO(3) |      |      |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
//_______,               _______,  _______,  _______,  _______,  _______,  _______,       _______,  _______,  _______,  _______,  _______,  _______,  _______,
  ...
  KC_LALT,               KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_MUTE,       XXXXXXX,  KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_ENT,
                                   _______,  KC_LALT,  KC_LCTL,  KC_LGUI,  KC_LSFT,       MO(2),    KC_SPC,   MO(3),    _______,  _______
),
/*
 * COLEMAK
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
//_______,               _______,  _______,  _______,  _______,  _______,  _______,       _______,  _______,  _______,  _______,  _______,  _______,  _______,
  ...
  KC_LALT,               KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_MUTE,       XXXXXXX,  KC_K,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_ENT,
                                   _______,  KC_LALT,  KC_LCTL,  KC_LGUI,  KC_LSFT,       MO(2),    KC_SPC,   MO(3),    _______,  _______
),
...
//_______,  _______,  _______,  _______,  _______,  _______,  _______,       _______,  _______,  _______,  _______,  _______,  _______,  _______,
  ...
  KC_GRV,   KC_BSLS,  KC_MINS,  KC_LBRC,  KC_RBRC,  KC_PGUP,                           KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  _______,  _______,
  _______,  DF(0),    DF(1),    MO(3),    _______,  KC_PGDN, _______,        _______,  KC_EQL,   _______,  _______,  _______,  _______,  KC_ENT,
...
//_______,  _______,  _______,  _______,  _______,  _______,                           _______,  _______,  _______,  _______,  _______,  _______,
  ...
  _______,  _______,  _______,  _______,  _______,  KC_HOME,                           KC_PDOT,  KC_4,     KC_5,     KC_6,     KC_PPLS,  KC_MINS,
  _______,  _______,  _______,  _______,  _______,  KC_END,   _______,       _______,  KC_0,     KC_1,     KC_2,     KC_3,     KC_SLSH,  KC_PEQL,
                      _______,  _______,  _______,  _______,  _______,       _______,  _______,  _______,  _______,  _______
),
};
